/*
 * $Id: TableModelSearchAResults.java 1082 2014-02-22 23:54:18Z draeger $
 * $URL: https://rarepos.cs.uni-tuebingen.de/svn-path/SBMLsqueezer/trunk/src/org/sbml/squeezer/sabiork/wizard/gui/TableModelSearchAResults.java $
 * ---------------------------------------------------------------------
...
public class TableModelSearchAResults extends AbstractTableModel {
  ...
  public TableModelSearchAResults() {
    ...
    searchAResults = new ArrayList<SearchAResult>();
  }
  ...
  public Object getValueAt(int rowIndex, int columnIndex) {
    SearchAResult searchAResult = searchAResults
        .get(rowIndex);
  ...
  public void add(SearchAResult searchAResult) {
    if (!searchAResults.contains(searchAResult)) {
      searchAResults.add(searchAResult);
      fireTableDataChanged();
    }
  }
