/*
 * $Id: OptionsGeneral.java 1082 2014-02-22 23:54:18Z draeger $
 * $URL: https://rarepos.cs.uni-tuebingen.de/svn-path/SBMLsqueezer/trunk/src/org/sbml/squeezer/OptionsGeneral.java $
 * ---------------------------------------------------------------------
...
public interface OptionsGeneral extends KeyProvider {
  ...
  /**
   * Can be {@code true} or {@code false}, depending on if the user wants to see
   * SBML warnings.
   */
