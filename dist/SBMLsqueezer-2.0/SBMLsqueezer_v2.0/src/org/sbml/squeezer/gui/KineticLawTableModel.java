/*
 * $Id: KineticLawTableModel.java 1081 2014-02-22 15:15:58Z draeger $
 * $URL: https://rarepos.cs.uni-tuebingen.de/svn-path/SBMLsqueezer/trunk/src/org/sbml/squeezer/gui/KineticLawTableModel.java $
 * ---------------------------------------------------------------------
...
public class KineticLawTableModel extends AbstractTableModel {
  ...
  public KineticLawTableModel(KineticLawGenerator klg, AbstractProgressBar progressBar) {
    ...
    data = new Object[klg.getCreatedKineticsCount()][columnNames.length];
