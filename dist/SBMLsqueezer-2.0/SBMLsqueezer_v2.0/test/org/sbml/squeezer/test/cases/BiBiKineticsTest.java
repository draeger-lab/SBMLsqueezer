 ...
 * $URL: https://rarepos.cs.uni-tuebingen.de/svn-path/SBMLsqueezer/trunk/test/org/sbml/squeezer/test/cases/BiBiKineticsTest.java $
 * ---------------------------------------------------------------------
...
public class BiBiKineticsTest extends KineticsTest {
  ...
  public void testPowerLawModularRateLawHalRev() throws Throwable {
    ...
    test(r1, kl, "vmag_r1*(keq_r1^hco_r1)^(0.5)*(s1*c1)^hco_r1*(s2*c1)^hco_r1/(kmc_r1_s1^hco_r1*kmc_r1_s2^hco_r1*kmc_r1_p1^hco_r1*kmc_r1_p2^hco_r1)^(0.5)-vmag_r1/(keq_r1^hco_r1)^(0.5)*(p1*c1)^hco_r1*(p2*c1)^hco_r1/(kmc_r1_s1^hco_r1*kmc_r1_s2^hco_r1*kmc_r1_p1^hco_r1*kmc_r1_p2^hco_r1)^(0.5)");
  }
