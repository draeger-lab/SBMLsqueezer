...
## \author  Michael Hucka, Ben Bornstein, Ben Kovitz
##
## $Id: setup.py.in,v 1.2 2005/03/29 00:39:02 bbornstein Exp $
## $Source: /cvsroot/sbml/libsbml/src/bindings/python/setup.py.in,v $
##
...
setup(name             = "libsbml", 
      ...
      license          = "LGPL",
      author           = "SBML Team",
      author_email     = "sbml-team@caltech.edu",
      url              = "http://sbml.org",
      py_modules       = ["libsbml"],
