...
public class SBMLParser {
	 ...
	 * in the same order as they are used in the stoichiometric matrix
	 * 
	 * @return
	 */
	...
	/**
	 * Returns an array with the ids of all participating species
	 * in the same order as they are used in the stoichiometric matrix
	 * 
	 * @return
	 */
...
//		} catch (ModelComplexityException e) {
//			e.printStackTrace();
//		} catch (UnexpectedASTNodeTypeException e) {
//			e.printStackTrace();
//		}
