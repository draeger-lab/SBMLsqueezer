...
public class JHelpBrowser extends JDialog implements ActionListener {
   ...
   */
  private void init() {
    browser = new JBrowser(/*"file://" + System.getProperty("user.dir")
        + System.getProperty("file.separator") + "resources"
        + System.getProperty("file.separator") + "html"
        + System.getProperty("file.separator") + */getClass().getResource("index.html"));
    ...
    try {
      Image image = ImageIO.read(getClass().getResource(
          ...
          + System.getProperty("file.separator") + */"back.png"));
    ...
    try {
      Image image = ImageIO.read(getClass().getResource(
          ...
          + System.getProperty("file.separator") + "resources"
          + System.getProperty("file.separator") + "images"
          + System.getProperty("file.separator") + */"forward.png"));
      //image = image.getScaledInstance(22, 22, Image.SCALE_SMOOTH);
