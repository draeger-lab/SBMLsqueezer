...
public class JSettingsPanel extends JPanel {
  ...
  public JSettingsPanel() {
    ...
    jSpinnerMaxRealisticNumOfReactants = new JSpinner(new SpinnerNumberModel(3,
        2, 10, 1));
    ...
    LayoutHelper.addComponent(jPanelGeneralOptions, layout, jCheckBoxWarnings,
        0, 1, 1, 1, 1, 0);
    LayoutHelper.addComponent(jPanelGeneralOptions, layout,
    ...
    jRadioButtonGenerateForAllReactions = new JRadioButton("For all reactions");
    ...
    jPanelGenerateNewKinetics.setBorder(BorderFactory.createTitledBorder(null,
        " Generate New Kinetics ", TitledBorder.DEFAULT_JUSTIFICATION,
        TitledBorder.DEFAULT_POSITION, titleFont, borderColor));
    ...
    jCheckBoxPossibleEnzymeTruncatedProtein = new JCheckBox("Truncated protein");
    ...
    jPanelSettingsReactionMechanism.setBorder(BorderFactory.createTitledBorder(
        null, " Reaction Mechanisms ", TitledBorder.CENTER,
        TitledBorder.DEFAULT_POSITION, titleFont, borderColor));
    ...
    nonEnzyme.setBorder(BorderFactory.createTitledBorder(null,
        ...
        TitledBorder.DEFAULT_POSITION, titleFont, borderColor));
    jRadioButtonGMAK = new JRadioButton("Genereralized mass-action kinetics");
    ...
    geneRegulation.setBorder(BorderFactory.createTitledBorder(null,
        " Gene Expression Regulation ", TitledBorder.DEFAULT_JUSTIFICATION,
        TitledBorder.DEFAULT_POSITION, titleFont, borderColor));
    ...
    LayoutHelper.addComponent(leftMechanismPanel, layout, nonEnzyme, 0, 0, 1,
        1, 1, 0);
    LayoutHelper.addComponent(leftMechanismPanel, layout, uniUniReactions, 0,
        1, 1, 1, 1, 0);
    LayoutHelper.addComponent(leftMechanismPanel, layout, biUniReactions, 0, 2,
        1, 1, 1, 0);
    layout = (GridBagLayout) rightMechanismPanel.getLayout();
    LayoutHelper.addComponent(rightMechanismPanel, layout, geneRegulation, 0,
        0, 1, 1, 1, 0);
    LayoutHelper.addComponent(rightMechanismPanel, layout, biBiReactions, 0, 1,
        1, 1, 1, 0);
    ...
    LayoutHelper.addComponent(this, layout, jPanelGeneralOptions, 0, 0, 2, 1,
        1, 0);
    LayoutHelper.addComponent(this, layout, jPanelGenerateNewKinetics, 0, 1, 1,
        1, 1, 0);
    LayoutHelper.addComponent(this, layout, jPanelSettingsReversibility, 1, 1,
        1, 1, 1, 0);
    LayoutHelper.addComponent(this, layout, jPanelSettingsEnzymes, 0, 2, 2, 1,
        1, 0);
    LayoutHelper.addComponent(this, layout, jPanelSettingsReactionMechanism, 0,
        3, 2, 1, 1, 0);
  ...
  public short getUniUniType() {
    if (jRadioButtonUniUniMMK.isSelected()) return (short) 3;
    if (jRadioButtonUniUniCONV.isSelected()) return (short) 2;
    return (short) 1; // GMAK.
  }
  ...
  public short getBiUniType() {
    if (jRadioButtonBiUniORD.isSelected()) return (short) 6;
    if (jRadioButtonBiUniRND.isSelected()) return (short) 4;
    if (jRadioButtonBiUniCONV.isSelected()) return (short) 2;
    return (short) 1; // GMAK.
  }
  ...
  public short getBiBiType() {
    if (jRadioButtonBiBiORD.isSelected()) return (short) 6;
    if (jRadioButtonBiBiPP.isSelected()) return (short) 5;
    if (jRadioButtonBiBiRND.isSelected()) return (short) 4;
    if (jRadioButtonBiBiCONV.isSelected()) return (short) 2;
    return (short) 1; // GMAK.
  }
  ...
  public boolean possibleEnzymeTestAllNotChecked() {
    ...
    if (!jCheckBoxPossibleEnzymeRNA.isSelected()
      ...
      if (getUniUniType() == 3)// .equals("MMK"))
        jRadioButtonUniUniMMK.setSelected(true);
      else jRadioButtonUniUniMMK.setSelected(false);

      if (getUniUniType() == 2)// .equals("CONV"))
        jRadioButtonUniUniCONV.setSelected(true);
      else jRadioButtonUniUniCONV.setSelected(false);

      if (getBiUniType() == 6)// .equals("ORD"))
        jRadioButtonBiUniORD.setSelected(true);
      else jRadioButtonBiUniORD.setSelected(false);

      if (getBiUniType() == 2)// .equals("CONV"))
        jRadioButtonBiUniCONV.setSelected(true);
      else jRadioButtonBiUniCONV.setSelected(false);

      if (getBiUniType() == 4)// .equals("RND"))
        jRadioButtonBiUniRND.setSelected(true);
      else jRadioButtonBiUniRND.setSelected(false);

      if (getBiBiType() == 5)// .equals("PP"))
        jRadioButtonBiBiPP.setSelected(true);
      else jRadioButtonBiBiPP.setSelected(false);

      if (getBiBiType() == 6)// .equals("ORD"))
        jRadioButtonBiBiORD.setSelected(true);
      else jRadioButtonBiBiORD.setSelected(false);

      if (getBiBiType() == 2)// .equals("CONV"))
        jRadioButtonBiBiCONV.setSelected(true);
      else jRadioButtonBiBiCONV.setSelected(false);

      if (getBiBiType() == 4)// .equals("RND"))
        jRadioButtonBiBiRND.setSelected(true);
      else jRadioButtonBiBiRND.setSelected(false);
  ...
  public void restoreDefaults() {
    ...
    jCheckBoxWarnings.setSelected(true);
    jSpinnerMaxRealisticNumOfReactants.setModel(new SpinnerNumberModel(3, 2,
        10, 1));
    jRadioButtonGMAK.setSelected(true);
  ...
  public int getMaxRealisticNumberOfReactants() {
    return ((Integer) jSpinnerMaxRealisticNumOfReactants.getValue()).intValue();
  }
  ...
  public void save(File file) {
    new SettingsWriter(file, getMaxRealisticNumberOfReactants(),
        ...
        isSetTreatAllReactionsReversible(), isPossibleEnzymeGenericProtein(),
        isPossibleEnzymeTruncatedProtein(), isPossibleEnzymeEnzymeComplex(),
   ...
   */
  public void loadSettings(File file) throws IOException, NumberFormatException {
    ...
    while (!paramLine.equals("END")) {
      ...
      if (paramLine.contains("maxSpecies")) {
        String paramValue = paramLine.substring(paramLine.indexOf(":") + 1);
        ...
        if (getMaxRealisticNumberOfReactants() < 2
          ...
          error = true;
          System.err.println("Irregular Value:(" + paramValue
              + ") at LoadToken:(" + 0
              + "). Expected is a regular value of range 2..10:(maxSpecies).");
        }
      }
      if (paramLine.contains("warnings"))
        setWarningsForUnrealisticReactions(Boolean.parseBoolean(paramLine
            .substring(paramLine.indexOf(":") + 1)));
      if (paramLine.contains("noReactionMAK")) {
        String paramValue = paramLine.substring(paramLine.indexOf(":") + 1);
        if (paramValue.equals("true"))
          setNonEnzymeReactionsType((short) 1);
        else if (paramValue.equals("false")) // TODO: What else can we do?
          setNonEnzymeReactionsType((short) 1);
        else {
          System.err.println("Unknown token:(" + paramValue
              + ") at LoadToken:(" + 2
      ...
      if (paramLine.contains("possibleEnzymeRNA"))
        setPossibleEnzymeRNA(Boolean.parseBoolean(paramLine.substring(paramLine
            .indexOf(":") + 1)));
      ...
      if (paramLine.contains("possibleEnzymeTruncatedProtein"))
        setPossibleEnzymeTruncatedProtein(Boolean.parseBoolean(paramLine
            .substring(paramLine.indexOf(":") + 1)));
      if (paramLine.contains("GenKinForAllReac"))
        setGenerateKineticsForAllReactions(Boolean.parseBoolean(paramLine
            .substring(paramLine.indexOf(":") + 1)));
      ...
      if (paramLine.contains("forceAllReactionsAsEnzymeReaction"))
        possibleEnzymeAllNotChecked = Boolean.parseBoolean(paramLine
            .substring(paramLine.indexOf(":") + 1));
      if (paramLine.contains("forceAllReactionsAsEnzymeReaction"))
        setAllReactionsAreEnzymeCatalyzed(Boolean.parseBoolean(paramLine
            .substring(paramLine.indexOf(":") + 1)));
    }
    load.close();
    if (error == true) {
