...
public interface SABIORKOptions extends KeyProvider {
   ...
   */
  public static final Option PATHWAY = new Option("PATHWAY", String.class, (ResourceBundle) OPTIONS_BUNDLE, (String) null);
  
  /**
   * The tissue for which the kinetics have been determined.
   */
  public static final Option TISSUE = new Option("TISSUE", String.class, (ResourceBundle) OPTIONS_BUNDLE, (String) null);
  
  /**
   * The cellular location for which the kinetics have been determined.
   */
  public static final Option CELLULAR_LOCATION = new Option("CELLULAR_LOCATION", String.class, (ResourceBundle) OPTIONS_BUNDLE, (String) null);
  
  /**
   * The organism for which the kinetics have been determined.
   */
  public static final Option ORGANISM = new Option("ORGANISM", String.class, (ResourceBundle) OPTIONS_BUNDLE, (String) null);
