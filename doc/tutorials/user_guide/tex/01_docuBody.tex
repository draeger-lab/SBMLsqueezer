...
\vrefrange{fig:startAutomatic}{fig:changes} show how you can add kinetic equations from \SABIO to an several reactions simultaneously. Please note: The reactions you want to equip with kinetic equations should be annotated with \KEGG reaction ids.
