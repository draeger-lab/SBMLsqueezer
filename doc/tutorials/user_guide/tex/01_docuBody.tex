...
The \KEGG identifier of a reaction is always included in the respective search, \pdfmarkupcomment[author={Andreas Dr\"ager}, color={yellow}]{because the $\backslash$API simultaneously searches for rate equations for several reactions.}{Unklar.}
