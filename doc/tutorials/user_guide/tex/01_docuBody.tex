...
available at \url{http://webservices.cs.uni-tuebingen.de/}, or launch it as a
\JavaWebStart application directly from your web browser by
clicking at
\url{http://www.cogsys.cs.uni-tuebingen.de/software/SBMLsqueezer/downloads/SBMLsqueezer.jnlp}.
...
Click on the SABIO-RK symbol and the wizard will be started. On the first window you can select the reactions you want to equip with kinetic equations from SABIO-RK.
Press Ctrl while clicking on these reactions and click on NEXT when finished.
The KEGG id of a reaction is always included in the respective search, as the API searches for rate equations for several reactions simultaneously.
On the next window you can add search terms that should apply for the rate equations of all reactions such as the organism by choosing from the provided terms and typing in the value of the term.
You can remove a query field again by clicking on DELETE.
...
A reaction is marked in green, if a matching rate equation has been found, yellow, if the found rate equations do not fit exactly to your model, and red, if no matching rate equation has been found.
If you are satisfied with the results, you can click on NEXT.
A summary of all necessary changes to the model for adding rate equations to the reactions marked in green, is displayed.
If you now click on FINISH and confirm the changes afterwards, the rate equations will be added and the necessary changes will be applied to your model.

\subsection{For selected reations}
Select a reaction and right-click on it. Then click on the SABIO-RK symbol and the wizard will be started.
The reaction is shown again in the first window and you can just click on NEXT.
A window for selecting search terms is shown afterwards.
You can add search tearms such as the organism by choosing from the provided terms and typing in the value of the term.
The search can be further restricted by changing the bounds of pH, temperature, etc. in the right panel.
You can remove a query field by clicking on DELETE (like when adding kinetic laws to several reactions simultaneously).
After you are satisfied with your choice of search terms, click on NEXT.
The rate equations that match your search criteria are displayed then.
You can select a reaction and click on NEXT or you can click on BACK and change your search criteria.
If you click on NEXT, you can then choose how to match the species, compartments, etc., contained in the selected rate equation to the respective \SBML elements in your model.
The necessary elements to import, such as function definitions contained in the rate equation to add, are also shown.
If you now click on NEXT, a summary of all necessary changes to the model for adding the selected rate equation is displayed.
Now click on FINISH  and confirm the changes afterwards.
Then the rate equation will be added and the necessary changes will be applied to your model.
...
\item[--read-from-sabio-rk{[} |={]}<Boolean>]
  ...
  obtained rate laws in the reaction kinetics database SABIO-RK. Note that
...
applied in addition to the actual rate law generation, such as the default
...
\item[--ignore-these-species-when-creating-laws{[} |={]}<String>]
  ...
  Default value: \texttt{C00001, C00038, C00070, C00076, C00080, C00175, C00238, C00282, C00291, C01327, C01528, C14818, C14819}
\end{description}
...
\item[--kinetics-gene-regulation{[} |={]}<Class>]
  ...
  \begin{itemize}
  \item\texttt{org.sbml.squeezer.kinetics.NetGeneratorLinear},
  \item\texttt{org.sbml.squeezer.kinetics.HSystem},
  \item\texttt{org.sbml.squeezer.kinetics.NetGeneratorNonLinear},
  \item\texttt{org.sbml.squeezer.kinetics.Weaver},
  \item\texttt{org.sbml.squeezer.kinetics.HillEquation},
  \item\texttt{org.sbml.squeezer.kinetics.SSystem},
  \item\texttt{org.sbml.squeezer.kinetics.AdditiveModelNonLinear},
  \item\texttt{org.sbml.squeezer.kinetics.HillRaddeEquation},
  \item\texttt{org.sbml.squeezer.kinetics.Vohradsky},
  \item\texttt{org.sbml.squeezer.kinetics.HillHinzeEquation}, and 
  \item\texttt{org.sbml.squeezer.kinetics.AdditiveModelLinear}.
  \end{itemize}
...
\item[--kinetics-zero-reactants{[} |={]}<Class>]
  ...
  \item\texttt{org.sbml.squeezer.kinetics.NetGeneratorLinear},
  \item\texttt{org.sbml.squeezer.kinetics.HSystem},
  \item\texttt{org.sbml.squeezer.kinetics.ZerothOrderReverseGMAK},
  \item\texttt{org.sbml.squeezer.kinetics.ZerothOrderForwardGMAK},
  \item\texttt{org.sbml.squeezer.kinetics.NetGeneratorNonLinear},
  \item\texttt{org.sbml.squeezer.kinetics.Weaver},
  \item\texttt{org.sbml.squeezer.kinetics.SSystem},
  \item\texttt{org.sbml.squeezer.kinetics.AdditiveModelNonLinear},
...
\item[--kinetics-reversible-non-enzyme-reactions{[} |={]}<Class>]
  ...
  \begin{itemize}
  \item\texttt{org.sbml.squeezer.kinetics.ZerothOrderForwardGMAK},
  \item\texttt{org.sbml.squeezer.kinetics.ZerothOrderReverseGMAK}, and
  \item\texttt{org.sbml.squeezer.kinetics.GeneralizedMassAction}.
  \end{itemize}
...
\item[--kinetics-reversible-uni-uni-type{[} |={]}<Class>]
  ...
  All possible values for type \texttt{<Class>} are:
  \begin{itemize}
  \item\texttt{org.sbml.squeezer.kinetics.DirectBindingModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.CommonModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.HillEquation},
  \item\texttt{org.sbml.squeezer.kinetics.SimultaneousBindingModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.ForceDependentModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.ConvenienceKinetics},
  \item\texttt{org.sbml.squeezer.kinetics.MichaelisMenten}, and
  \item\texttt{org.sbml.squeezer.kinetics.PowerLawModularRateLaw}.
  \end{itemize}
...
\item[--kinetics-reversible-bi-uni-type{[} |={]}<Class>]
  ...
  \item\texttt{org.sbml.squeezer.kinetics.ForceDependentModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.ConvenienceKinetics},
  \item\texttt{org.sbml.squeezer.kinetics.RandomOrderMechanism},
  \item\texttt{org.sbml.squeezer.kinetics.OrderedMechanism}, and
  \item\texttt{org.sbml.squeezer.kinetics.PowerLawModularRateLaw}.
  \end{itemize}
...
\item[--kinetics-reversible-bi-bi-type{[} |={]}<Class>]
  ...
  \begin{itemize}
  \item\texttt{org.sbml.squeezer.kinetics.DirectBindingModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.PingPongMechanism},
  \item\texttt{org.sbml.squeezer.kinetics.CommonModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.SimultaneousBindingModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.ForceDependentModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.ConvenienceKinetics},
...
\item[--kinetics-reversible-arbitrary-enzyme-reactions{[} |={]}<Class>]
  ...
  \item\texttt{org.sbml.squeezer.kinetics.SimultaneousBindingModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.ForceDependentModularRateLaw},
  \item\texttt{org.sbml.squeezer.kinetics.ConvenienceKinetics}, and
  \item\texttt{org.sbml.squeezer.kinetics.PowerLawModularRateLaw}.
  \end{itemize}
...
\item[--kinetics-irreversible-uni-uni-type{[} |={]}<Class>]
  ...
  All possible values for type \texttt{<Class>} are:
  \begin{itemize}
  \item\texttt{org.sbml.squeezer.kinetics.IrrevCompetNonCooperativeEnzymes},
  \item\texttt{org.sbml.squeezer.kinetics.IrrevNonModulatedNonInteractingEnzymes},
  \item\texttt{org.sbml.squeezer.kinetics.HillEquation},
  \item\texttt{org.sbml.squeezer.kinetics.ConvenienceKinetics}, and
  \item\texttt{org.sbml.squeezer.kinetics.MichaelisMenten}.
  \end{itemize}
  Default value: \texttt{org.sbml.squeezer.kinetics.MichaelisMenten}
...
\item[--kinetics-irreversible-bi-uni-type{[} |={]}<Class>]
  ...
  \item\texttt{org.sbml.squeezer.kinetics.IrrevNonModulatedNonInteractingEnzymes},
  \item\texttt{org.sbml.squeezer.kinetics.ConvenienceKinetics},
  \item\texttt{org.sbml.squeezer.kinetics.RandomOrderMechanism}, and
  \item\texttt{org.sbml.squeezer.kinetics.OrderedMechanism}.
  \end{itemize}
  Default value: \texttt{org.sbml.squeezer.kinetics.RandomOrderMechanism}
...
\item[--kinetics-irreversible-arbitrary-enzyme-reactions{[} |={]}<Class>]
  ...
  All possible values for type \texttt{<Class>} are:
  \begin{itemize}
  \item\texttt{org.sbml.squeezer.kinetics.IrrevNonModulatedNonInteractingEnzymes} and
  \item\texttt{org.sbml.squeezer.kinetics.ConvenienceKinetics}.
  \end{itemize}
  Default value:
...
\item[--lowest-date{[} |={]}<Date>]
  ...
  inserted into SABIO-RK.
  Default value: \texttt{Wed Oct 15 00:00:00 PDT 2008}
\end{description}

\section{SABIO-RK search options}
\subsection{General options}
\begin{description}
\item[--pathway{[} |={]}<String>]
...
\item[--load-latex-compiler{[} |={]}<File>]
  ...
  (*).
  Default value: \texttt{/Users/draeger/Documents/workspace/SBMLsqueezer}
\end{description}
...
\item[--show-predefined-units{[} |={]}<Boolean>]
  ...
  is only available if the option \texttt{INCLUDE\_SECTION\_UNIT\_DEFINITIONS}
  is active.
  Default value: \texttt{true}
...
\item[--print-full-ode-system]
  ...
  is only available if the option \texttt{INCLUDE\_SECTION\_REACTIONS}
  is active.
  Default value: \texttt{false}
...
\item[--reactants-overview-table]
  ...
  \texttt{INCLUDE\_SECTION\_REACTIONS}
  is active.
  Default value: \texttt{false}
\end{description}
...
\item[--font-headings{[} |={]}<SansSerifFont>]
  ...
  \texttt{avant}, \texttt{cmss}, and \texttt{helvetica}.
...
\item[--font-text{[} |={]}<SerifFont>]
  ...
  \texttt{chancery}, \texttt{charter}, \texttt{cmr}, \texttt{mathptmx},
  \texttt{palatino}, \texttt{times}, and \texttt{utopia}.
...
\item[--include-section-initial-assignments{[} |={]}<Boolean>] This option decides whether or not a section about initial assignments
  should be included in the resulting model report. Note that
  this option only causes an effect if the model declares any
  initial assignments.
  Default value: \texttt{true}
