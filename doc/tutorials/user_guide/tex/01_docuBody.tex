...
A found kinetic law is added to a reaction if all contained elements can be matched to \SBML elements in thes model.
\lstinputlisting[caption={\SABIO query for the reactions of a model}, label={lst:SBMLsqueezer2API1}, firstline={102}, lastline={143}]{../../../examples/src/org/sbml/squeezer/test/SABIORKApplication.java}
...
\lstinputlisting[caption={Calling the \SABIO wizard}, label={lst:SBMLsqueezer2API1}, firstline={52}, lastline={100}]{../../../examples/src/org/sbml/squeezer/test/SABIORKApplication.java}
