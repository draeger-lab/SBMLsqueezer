...
\end{figure}
\Crefrange{fig:startAutomatic}{fig:changes} show how you can add kinetic equations from \SABIO to an several reactions at once.
To ensure that entries for the reactions of interest can be found in \SABIO, it is important to annotate these reactions with identifiers from the \KEGG database.
...
As an alternative you can add kinetic equations from \SABIO to a selected reaction separately. This is shown in \vrefrange{fig:startManual}{fig:changesManual}.
...
When using the stand-alone version of SBMLsqueezer, you can see a tree representation of the \SBML document you are working with on the left-hand side of the \GUI (\vref{fig:Viewing_Results}).
...
\section{Using SBMLsqueezer 2 as an equation generator library}

Source-code examples.
Adjust preferences.
Pass a model to the API.

\section{Using SBMLsqueezer 2 as an online program}
