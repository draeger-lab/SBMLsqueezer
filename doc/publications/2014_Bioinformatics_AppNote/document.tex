...
%\section{Results:}
The program SBMLsqueezer is a generator for kinetic equations, parameters, and units.
...
%SBMLsqueezer has been implemented with the aim to simplify the difficult %and highly error-prone
...
\begin{figure}
\centering{\includegraphics[width=.48\textwidth]{Screenshot_4.png}}
\caption[Graphical user interface of SBMLsqueezer]{Graphical user interface of SBMLsqueezer.%\vspace{-.75cm}
...
%SBMLsqueezer's API, all command-line options as well as 
...
\bibitem[Dr{\"a}ger {\em et~al.}(2009b)Dr{\"a}ger {\em et~al.}]{Draeger2009b}
Dr{\"a}ger {\em et~al.} (2009b).
